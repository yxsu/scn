...
class Token(object):
    ...
    def generate_verifier(length = 32):
        """generate the string list of pseudorandom number."""
        return ''.join([str(random.randint(0, 9)) for i in length(length)])
